        ...
        <div>
            ...
            <div className="flex flex-col gap-6 items-center justify-center mt-16">
                <div className=" flex justify-center gap-3  ">
                    <input className="h-8 rounded-lg px-2 w-20 text-xl text-center font-medium" placeholder="num" type="number" name="num" value={inputNum} onChange={onChange} />
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 -my-3 ">
